...
namespace Pinicules.Domain.Tests
{
    ...
    public class MoviesServiceTests
    {
        ...
        public void WhenGettingMoviesShouldCallToMoviesRepository()
        {
            ...
            moviesService.GetMovies("", string.Empty, 1, 1, 10);

            movieRepositoryMock.Verify(mr => mr.GetMovies("", string.Empty, 1, 1, 10), Times.Once());
        }
        ...
        public void ForEachMovieRetrievedShouldCallToTmdbRepositoryGetMovieInformation()
        {
            ...
            movieRepositoryMock.Setup(mr => mr.GetMovies("", string.Empty, It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>())).Returns(movies);
            ...
            moviesService.GetMovies("", string.Empty, movies.Count, 1, 10);
        ...
        public void GetMoviesShouldReturnAnArrayOfMoviesFilled()
        {
            ...
            movieRepositoryMock.Setup(mr => mr.GetMovies("", string.Empty, 2, 1, 10)).Returns(new List<MovieDTO> { dbMovie1, dbMovie2 });
            ...
            var resultMovies = moviesService.GetMovies("", string.Empty, 2, 1, 10);
