...
namespace Pinicules.Data.Tests
{
    ...
    public class MoviesRepositoryTests
    {
        ...
        {
            var movies = moviesRepository.GetMovies(string.Empty, 11, 1, 10);
        ...
        {
            var movies = moviesRepository.GetMovies(string.Empty, 11, 2, 10);
        ...
        {
            var movies = moviesRepository.GetMovies("spider", 11, 1, 10);
        ...
        public void TestAdd()
        {
            ...
            var movies = moviesRepository.GetMovies("", 20, 1, 10);

            Assert.AreEqual(16, movies.Count);

            movies = moviesRepository.GetMovies("movie", 20, 1, 10);
            Assert.AreEqual(1, movies.Count);
